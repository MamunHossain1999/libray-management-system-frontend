      ...
      <section className="py-12 px-4 container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src={img1} alt="Blog 1" className="w-full h-48 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src={img2} alt="Blog 2" className="w-full h-48 object-cover" />
            <div className="p-4">
              <h4 className="font-semibold mb-2">
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <img src={img3} alt="Blog 3" className="w-full h-48 object-cover" />
            <div className="p-4">
              <h4 className="font-semibold mb-2">
